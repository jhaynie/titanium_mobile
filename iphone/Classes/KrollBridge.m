...
-(void)willStartNewContext:(KrollContext*)kroll
{
	...
	if (cls) {
		[cls performSelector:@selector(willStartNewContext:) withObject:kroll withObject:self];
	}
...
-(void)didStartNewContext:(KrollContext*)kroll
{
	...
	Class cls = NSClassFromString(@"Hyperloop");
	if (cls) {
		[cls performSelector:@selector(didStartNewContext:) withObject:kroll withObject:self];
	}
...
-(void)willStopNewContext:(KrollContext*)kroll
{
	...
	Class cls = NSClassFromString(@"Hyperloop");
	if (cls) {
		[cls performSelector:@selector(willStopNewContext:) withObject:kroll withObject:self];
	}
...
-(void)didStopNewContext:(KrollContext*)kroll
{
	...
	Class cls = NSClassFromString(@"Hyperloop");
	if (cls) {
		[cls performSelector:@selector(didStopNewContext:) withObject:kroll withObject:self];
	}
